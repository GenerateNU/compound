  ...
  return (
    <main className="bg-white flex flex-col items-center px-5">
      <section className="flex w-full max-w-[1292px] flex-col items-stretch mt-8 mb-8 max-md:max-w-full max-md:my-10">
        ...
        <div className="justify-center text-black text-center text-3xl leading-10 self-center max-w-[999px] mt-10 max-md:max-w-full max-md:mt-10">
        ...
        <div className="self-center flex w-full max-w-[1248px] justify-between gap-5 mt-14 max-md:max-w-full max-md:flex-wrap max-md:mt-10">
          <div className="flex grow basis-[0%] flex-col items-stretch">
            <div className="flex items-stretch justify-between gap-5 pb-10">
              ...
              <div className="justify-center text-black text-left text-2xl leading-8 self-center grow shrink basis-auto my-auto">
          ...
          <div className="flex grow basis-[0%] flex-col max-md:max-w-full">
            <div className="flex items-stretch gap-5 pb-10">
              <div className="text-zinc-600 text-center text-base font-semibold leading-4 whitespace-nowrap justify-center items-stretch bg-white aspect-[1.0344827586206897] px-2.5 py-2 rounded-lg border-2 border-solid border-zinc-600">
                2
              </div>
        ...
        <div className="flex w-[422px] max-w-full items-stretch justify-between gap-5 mt-10 self-end max-md:flex-wrap max-md:mt-10">
